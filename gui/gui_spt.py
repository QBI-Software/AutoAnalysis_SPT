...
class ConfigPanel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText66 = wx.StaticText( self, wx.ID_ANY, u"Group By ROI", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText66.Wrap( -1 )
		fgSizer1.Add( self.m_staticText66, 0, wx.ALL, 5 )
		
		self.m_cbROI = wx.CheckBox( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		fgSizer1.Add( self.m_cbROI, 0, wx.ALL, 5 )
