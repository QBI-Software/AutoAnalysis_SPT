...
###########################################################################
## Class MSD Configuration
###########################################################################

class AppConfiguration(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"MSD Configuration", pos=wx.DefaultPosition,
                          size=wx.Size(441, 508),
                          style=wx.DEFAULT_FRAME_STYLE | wx.FRAME_FLOAT_ON_PARENT | wx.TAB_TRAVERSAL)


        self.SetSizeHintsSz(wx.DefaultSize, wx.DefaultSize)

        fgSizer1 = wx.FlexGridSizer(14, 2, 0, 0)
        fgSizer1.SetFlexibleDirection(wx.BOTH)
        fgSizer1.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)

        self.m_Title = wx.StaticText(self, wx.ID_ANY, u"MSD Config params", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_Title.Wrap(-1)
        self.m_Title.SetFont(wx.Font(12, 70, 90, 90, False, wx.EmptyString))

        fgSizer1.Add(self.m_Title, 0, wx.ALL, 5)
        ...
        self.m_staticText18 = wx.StaticText(self, wx.ID_ANY, u"Data Filename (eg AllROI-D.txt)", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        ...
        self.m_staticText19 = wx.StaticText(self, wx.ID_ANY, u"MSD Filename (eg AllROI-MSD.txt)", wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        ...
        self.m_staticText3 = wx.StaticText(self, wx.ID_ANY, u"Histogram Filename", wx.DefaultPosition, wx.DefaultSize,
                                           0)
